...
if __name__ == '__main__':
    ...
    a = 1
    v_a = a * features_max
    df_range = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0]
    optAcc = 0

    #TO RUN VEC OPT: comment in relevant optimization term loop
    for df_max in df_range:
    #for df_min in df_range:
    #for features_max in range  (1000, 3000, 100):
